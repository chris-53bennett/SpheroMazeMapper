...
public class UiSampleActivity extends ControllerActivity {
    ...
    /** DEV NOTES: Don't modify this section.  It will work for our purposes**/
    @Override
    ...
    /** Dev Notes: Don't mess with this.  It will disconnect the Sphero when the user transitions
     * away from the app **/
    @Override
    ...
    /** Dev Notes: We will have to add to this function to include the other layouts when the user
     *  exits the app **/
    @Override
    ...
    /** Dev Notes: We can keep this option, but we will have to move the location of the
     *  color picker button**/
   ...
   /** Dev Notes: Definitely keep this option.  May have to move the button location in layout**/

    public void onSleepClick(View v) {
        mSlideToSleepView.show();
    }

    /**Dev Notes: We may have to add widgets.  Not really sure how this works.
     *  investigater further**/
